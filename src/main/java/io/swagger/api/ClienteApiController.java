...
public class ClienteApiController implements ClienteApi {
	...
	public ResponseEntity<Cliente> alteraCliente(@ApiParam(value = "Id do cliente.", required = true) @PathVariable("id") Integer id, @ApiParam(value = "", required = true) @Valid @RequestBody Cliente cliente) {
